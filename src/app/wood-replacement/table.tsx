...
export function WoodReplacementTable({
    data,
    onEdit,
    onDelete,
    onAddNew,
    isLoading = false,
}: WoodReplacementTableProps) {
    ...
    const columns: ColumnDef<WoodReplacement, any>[] = [
        {
            ...
            meta: { label: 'Replace Cost ID' } as ColumnMeta,
        },
        {
            ...
            meta: { label: 'Wood ID' } as ColumnMeta,
        },
        {
        ...
        },
        {
            ...
            meta: { label: 'Thickness' } as ColumnMeta,
        },
        {
            ...
            meta: { label: 'Waste Factor' } as ColumnMeta,
        },
        {
            ...
            meta: { label: 'Unit' } as ColumnMeta,
        },
        {
        // Updated Replacement column: always show 2 decimals.
            accessorFn: (row) =>
                row.replacement != null ? Number(row.replacement).toFixed(2) : "0.00",
            id: 'replacement',
            header: ({ column }) => (
                <Button
                variant="ghost"
            ...
            meta: { label: 'Replacement' } as ColumnMeta,
        },
        {
            ...
            meta: { label: 'Updated Date' } as ColumnMeta,
        },
        {
            id: 'actions',
            header: 'Actions',
    ...
    <div className="space-y-2">
        <div className="flex flex-col gap-4 sm:flex-row sm:justify-between">
            ...
            <Button onClick={onAddNew} className="bg-neutral-900 text-white hover:bg-neutral-700 w-full sm:w-auto">
                <LuPlus className="mr-1" /> Add Wood Replacement
            </Button>
        </div>
